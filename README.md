# [roq-phemex-futures](https://roq-trading.com/docs/reference/gateways/crypto/roq-phemex-futures/)

Roq's Phemex futures gateway.
...
Reference documentation can be found [here](https://roq-trading.com/docs/reference/gateways/crypto/roq-phemex-futures/).
