...
#include "roq/phemex_futures/proto_bridge/application.hpp"
...
auto const INFO = roq::Service::Info{
    .description = "Roq's Phemex futures gateway (Protobuf interface)"sv,
...
int main(int argc, char **argv) {
  ...
  return roq::phemex_futures::proto_bridge::Application{args, settings, INFO}.run();
}
