...
template <>
struct fmt::formatter<roq::phemex_futures::proto_bridge::Settings> {
  constexpr auto parse(format_parse_context &context) { return std::begin(context); }
  auto format(roq::phemex_futures::proto_bridge::Settings const &value, format_context &context) const {
