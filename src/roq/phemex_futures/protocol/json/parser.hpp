...
#include "roq/phemex_futures/protocol/json/book.hpp"
#include "roq/phemex_futures/protocol/json/kline.hpp"
#include "roq/phemex_futures/protocol/json/market24h.hpp"
#include "roq/phemex_futures/protocol/json/trades.hpp"

#include "roq/phemex_futures/protocol/json/accounts_orders_positions.hpp"
...
struct Parser final {
  struct Handler {
    ...
    //
    virtual void operator()(Trace<protocol::json::Book> const &) = 0;
    virtual void operator()(Trace<protocol::json::Trades> const &) = 0;
    virtual void operator()(Trace<protocol::json::Market24h> const &) = 0;
    virtual void operator()(Trace<protocol::json::Kline> const &) = 0;
    //
    virtual void operator()(Trace<protocol::json::IndexMarket24h> const &) = 0;
    virtual void operator()(Trace<protocol::json::AccountsOrdersPositions> const &) = 0;
