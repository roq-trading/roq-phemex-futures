...
void OrderEntryCoinM::get_open_orders_ack(Trace<web::rest::Response> const &event, uint32_t sequence) {
...
void OrderEntryCoinM::operator()(Trace<json::OpenOrders> const &event) {
...
void OrderEntryCoinM::get_fill_history() {
...
void OrderEntryCoinM::get_fill_history_ack(Trace<web::rest::Response> const &event, uint32_t sequence) {
...
void OrderEntryCoinM::operator()(Trace<json::FillHistory> const &event) {
